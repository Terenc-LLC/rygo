...
* [TER-338](https://linear.app/terenc/issue/TER-338) — ✅ In Review. RefThumbnail light-mode Paper-gap alignment: `CELL_BG.empty` `bg-stone-300` → `bg-stone-400`; both container backgrounds `bg-grid-line` → `bg-paper`. `--color-grid-line` token removed from `index.css` (zero consumers after edit). `RefThumbnail.test.tsx` updated. Dark mode unchanged. Filed June 5, 2026.
