...
* [TER-342](https://linear.app/terenc/issue/TER-342) — ✅ In Review. Homepage SEO + social meta hardening: full `<head>` meta block in `index.html` (`<title>`, canonical, description, theme-color, og:type/site_name/title/description/image/width/height/url, twitter:card/title/description/image). Shipped June 5, 2026.
